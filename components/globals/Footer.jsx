            ...
            <div className="container">
                <div className="flex flex-col">
                    <div className="flex flex-col md:grid md:grid-cols-12 gap-y-20 md:gap-y-0">
                        <div className="md:col-span-7 flex flex-col justify-between gap-y-14">
                            <Link className="w-full max-w-[100px] aspect-[100/125] relative" href="/" aria-label="Go to homepage">
                                {/* <svg
                                    width="259"
                                    height="17"
                                    viewBox="0 0 259 17"
                                ...
                                <Image src={FooterLogo} alt="Riven Oak Design logo" fill className="object-contain"  />
                            </Link>
                            {renderAddress && (
                        ...
                        <div className="flex flex-wrap md:flex-nowrap md:col-span-5 gap-x-10 gap-y-20 md:gap-x-20 justify-between">
                            <nav>
